...
export default function FeaturedAdvanced() {
  ...
  return (
    <section className="w-full flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="lg:w-1/2 w-full h-[55vh] sm:h-[60vh] lg:h-screen relative order-1 lg:order-2">
        <Image
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-10 lg:px-16 text-white max-w-xl">
      ...
      <div className="lg:w-1/2 w-full flex flex-col items-center justify-center px-6 sm:px-10 lg:px-12 py-12 lg:py-0 order-2 lg:order-1">
        ...
        <div className="w-full max-w-lg mb-8">
          <p className="text-xs uppercase tracking-[0.25em] font-semibold text-gray-500 mb-2">
            Featured
          </p>
        ...
        {/* STACKED CARDS */}
        <div className="relative w-full max-w-md sm:max-w-lg h-80 sm:h-95 lg:h-105">
